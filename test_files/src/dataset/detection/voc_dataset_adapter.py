...
class VOCDatasetAdapter:
    ...
    def target_transform(clst, target):
        target_classes = ["aeroplane", "bicycle", "bird", "boat", "bottle", "bus", "car", "cat", "chair", "cow", "diningtable", "dog", "horse", "motorbike", "person", "pottedplant", "sheep", "sofa", "train", "tvmonitor"]
        ...
        for t in target['annotation']['object']:
            annots['boxes'].append([int(x) for x in [t['bndbox']['xmin'], t['bndbox']['ymin'], t['bndbox']['xmax'], t['bndbox']['ymax']]])
